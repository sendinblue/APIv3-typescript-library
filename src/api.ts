...
export class CreateSmtpEmail {
    ...
    */
    ...
    /**
        ...
        * @param filterAttributes Filter by attrbutes. If you have filter for owner on your side please send it as &#x60;attributes.owner&#x60;.\&quot;
        * @param filterLinkedCompaniesIds Filter by linked companies ids
        * @param filterLinkedContactsIds Filter by linked companies ids
        * @param offset Index of the first document of the page
        * @param limit Number of documents per page
        * @param sort Sort the results in the ascending/descending order. Default order is **descending** by creation if &#x60;sort&#x60; is not passed
        * @param sortBy The field used to sort field names.
        * @param {*} [options] Override http request options.
        */
    public crmDealsGet (filterAttributes?: string, filterLinkedCompaniesIds?: string, filterLinkedContactsIds?: string, offset?: number, limit?: number, sort?: 'asc' | 'desc', sortBy?: string, options: any = {}) : Promise<{ response: http.IncomingMessage; body: DealsList;  }> {
        ...
        if (filterAttributes !== undefined) {
            localVarQueryParameters['filter[attributes]'] = ObjectSerializer.serialize(filterAttributes, "string");
        }

        if (filterLinkedCompaniesIds !== undefined) {
            localVarQueryParameters['filter[linkedCompaniesIds]'] = ObjectSerializer.serialize(filterLinkedCompaniesIds, "string");
        }

        if (filterLinkedContactsIds !== undefined) {
            localVarQueryParameters['filter[linkedContactsIds]'] = ObjectSerializer.serialize(filterLinkedContactsIds, "string");
        }
